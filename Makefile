...
BASH_SCRIPTS := rc init-rip-cage.sh hooks/*.sh bd-wrapper.sh tests/test-prerequisites.sh tests/test-docker-daemon-hang.sh tests/test-manifest-schema.sh tests/test-manifest-tool.sh tests/test-manifest-egress.sh tests/test-manifest-shell.sh tests/test-manifest-daemon.sh tests/test-manifest-agent-mail.sh tests/test-manifest-cross.sh tests/test-manifest-security.sh tests/test-manifest-herdr.sh tests/test-multiplexer-lifecycle.sh tests/test-manifest-multiplexer-validate.sh

...
# ---------------------------------------------------------------------------
echo "=== (b) Function-count invariant (measured pre-split count: 193, current: 211) ==="
...
if [[ "$_missing_count" -eq 0 ]]; then
  pass "(c)" "all 211 rc-reachable functions are declare -F reachable after sourcing rc"
else

...
# ---------------------------------------------------------------------------
echo "=== (c) declare -F reachability: all 212 rc-reachable functions defined after sourcing rc ==="
...
if [[ "$_missing_count" -eq 0 ]]; then
  pass "(c)" "all 212 rc-reachable functions are declare -F reachable after sourcing rc"
else

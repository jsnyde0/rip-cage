...
# ---------------------------------------------------------------------------
echo "=== (b) Function-count invariant (measured pre-split count: 193, current: 209) ==="
...
if [[ "$_missing_count" -eq 0 ]]; then
  pass "(c)" "all 209 rc-reachable functions are declare -F reachable after sourcing rc"
else

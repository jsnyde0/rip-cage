...
# ---------------------------------------------------------------------------
echo "=== (b) Function-count invariant (measured pre-split count: 193, current: 206) ==="
...
# ---------------------------------------------------------------------------
echo "=== (c) declare -F reachability: all 206 rc-reachable functions defined after sourcing rc ==="
...
if [[ "$_missing_count" -eq 0 ]]; then
  pass "(c)" "all 206 rc-reachable functions are declare -F reachable after sourcing rc"
else

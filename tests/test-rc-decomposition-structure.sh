...
# ---------------------------------------------------------------------------
echo "=== (b) Function-count invariant (measured pre-split count: 193, current: 202) ==="
...
if [[ "$_missing_count" -eq 0 ]]; then
  pass "(c)" "all 202 rc-reachable functions are declare -F reachable after sourcing rc"
else

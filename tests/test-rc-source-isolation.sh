...
#       rc:']] && return 0''s `return 0` would fire at the top level of a non-sourced script
...
#       dispatch-skip predicate at rc:']] && return 0'. Drift between the two is the regression
...
# sourced, then rc:']] && return 0''s `return 0` would execute at the top level of a

...
write_snapshot '{"version":1,"ssh":{"allowed_hosts":[],"allowed_keys":null}}'
...
write_snapshot '{"version":1,"ssh":{"allowed_hosts":["switch.berlin"],"allowed_keys":null}}'
...
write_snapshot '{"version":1,"ssh":{"allowed_hosts":[],"allowed_keys":["different_key.pub"]}}'
...
make_docker_stub "$STUB_DIR" "$CNAME" "running" "$WS"
write_snapshot '{"version":1,"ssh":{"allowed_hosts":[],"allowed_keys":null}}'  # snapshot: null
...
write_snapshot '{"version":1,"ssh":{"allowed_hosts":[],"allowed_keys":null},"egress":{"mode":"denylist"}}'
...
write_snapshot '{"version":1,"ssh":{"allowed_hosts":["switch.berlin"],"allowed_keys":null},"egress":{"mode":"denylist"}}'

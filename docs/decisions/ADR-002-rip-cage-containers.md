...
**Added:** 2026-03-27 (manual testing). **Re-mechanized:** 2026-07-28 (rip-cage-r5f9, msb cutover — mechanism updated in place per ADR-029 D2's edit ledger; firmness held at the original FIRM pending an explicit firmness ruling). **Firmness ruled:** 2026-07-29 (human ruling, relayed via brain:rip-cage) — FLEXIBLE: the principle (rc must reliably self-detect in-cage, unforgeably by the agent) is not in question, but the concrete marker mechanism is one migration old and may evolve with judgment; the invalidation clause below names the known re-open trigger.

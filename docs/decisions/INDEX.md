...
| [019](ADR-019-pi-coding-agent-support.md) | pi-coding-agent Support | pi-agent | Proposed | Single pi mount, no auth-warn, cage topology reference; D4 phase-1 promoted to required |

...
| [021](ADR-021-layered-rip-cage-config.md) | Layered rip-cage Config | config | Proposed (revised 2026-06-13) | Two-file substrate: global + project `.rip-cage.yaml`; per-field merge rules; versioning; D6 `session.multiplexer` enum (none\|tmux\|herdr, default none) |

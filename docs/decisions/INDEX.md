...
| [005](ADR-005-ecosystem-tools.md) | Ecosystem Tools Integration | toolchain | Proposed | Build-arg toggles for optional tools; pinned versions via manifest |
...
| [019](ADR-019-pi-coding-agent-support.md) | pi-coding-agent Support | pi-agent | Proposed | Container-local pi dir + narrow durable sub-mounts (D1 rev 2026-06-01), no auth-warn, cage topology reference; D4 phase-1 promoted to required |
